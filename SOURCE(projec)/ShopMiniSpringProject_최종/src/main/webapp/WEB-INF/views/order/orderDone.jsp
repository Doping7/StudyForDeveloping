...
<table width="70%" cellspacing="0" cellpadding="0">
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="td_default" height="35"> ${dto.orderName}고객님</td>
				</tr>
				<tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td height="35" class="td_default" align="center">
						<span id = "num1">${dto.gAmount}</span>권
					</td>
					<td height="35" class="td_default" align="center">
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<input type = 'text' id = 'total' value = '${dto.gPrice*dto.gAmount}' readonly>원
					</td>
				</tr>
				<tr>
	...
	<tr>
		<td class="td_default" align="center"><a class="a_default"
			href="cartList">주문조회 페이지로 이동</a></td>
	</tr>
