...
//		return mav;
	...
	@ResponseBody
	public void cartDelete(String num) {//key값이 num
...
//	}
	...
	public String orderConfirm(String num, HttpSession session, RedirectAttributes m) {
		System.out.println(num);
		MemberDTO mdto = (MemberDTO)session.getAttribute("login");
	...
	public String orderDone(OrderDTO dto, String orderNum, HttpSession session, RedirectAttributes m) {
		System.out.println(dto);
