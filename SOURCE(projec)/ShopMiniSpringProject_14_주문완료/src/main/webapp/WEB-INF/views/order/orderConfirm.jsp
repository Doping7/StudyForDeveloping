...
<input type="hidden" name="orderNum" value="${cart.num}"><!-- 장바구니 번호 : 주문 후 cart에서 삭제할때 사용할 것 -->
			...
			<td>
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="td_default" align='right'>${cart.gPrice * cart.gAmount}원</td>
					</tr>
				</table> <tr>
			<td>
					<hr size="1" color="CCCCCC">
				...
				<tr>
					...
					<td height="35" class="td_default">
						<input class="input_default" type="text" id="mname" size="20"
							maxlength="20" value="${member.username}"></input>
					</td>
				</tr>
				<tr>
					<td height="35" class="td_default">
					...
					<td height="35" class="td_default">
						<input class="input_default" type="text" id="mpost1" size="4"
							maxlength="3" value="${member.post}" readonly></input>
				...
				<tr>
					...
					<td height="35" class="td_default">
						<input class="input_default" type="text" id="maddress1" size="35"
							maxlength="200" value="${member.addr1}" readonly></input><br>
						<input class="input_default" type="text" id="maddress2" size="35"
							maxlength="200" value="${member.addr2}" readonly></input>
					</td>
				</tr>
				...
				<tr>
					...
					<td height="35" class="td_default">
						<input class="input_default" type="text" id="mphone" size="15"
							maxlength="15" value="${member.phone1}${member.phone2}${member.phone3}"></input>
